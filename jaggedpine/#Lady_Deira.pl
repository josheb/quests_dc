...
sub EVENT_ITEM {
	if (plugin::check_handin(\%itemcount, 8918 => 1, 8917 => 1)) {
  	...
  	if (plugin::check_handin(\%itemcount, 8952 => 1)) { ## Tempest Guard's Stone
		quest::emote("gives a warm, gentle smile and a deep bow of respect to you as she extends a white steel crown ornamented with a single blue gem, 'Welcome to the Veterans of the Storm, and we honor you as Tempest Guard $n. Bear this symbol in humility and as a sign of your eternal pledge in service and protection of all that The Rainkeeper holds dear and sacred.' ");
...
## Edited/Jayseesee to finish out Crown of the Tempest Guard quest.