...
sub EVENT_SAY {
  ...
  if ($text=~/i have work for you/i) {
    quest::say("Very good. Very good. What I require, if it is the whistler ya seek, is 500 platinum and the two components necessary, Frontier Ore and a Gem 'o Nimbleness. Once I have all three, I will then commence ta doin that right away fer ya.");
  }
}
