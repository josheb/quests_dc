...
sub EVENT_ITEM
{
  if(plugin::check_handin(\%itemcount, 6970 => 1, 6971 => 1, 6972 => 1))
{
#Valley Spiritling Stone, Jungle Spiritling Stone, Mountain Spiritling Stone
    ...
    {
      quest::summonitem(6980);
        #Kejek Spirit Powder x 1 to 3 (Random)
    }
  }
  elsif(plugin::check_handin(\%itemcount, 6980 => 1, 6977 => 1))
  {
    ...
    quest::summonitem(2576);
    #Shattered Soul Orb
    quest::faction(172,10);
    #Kejek Village
